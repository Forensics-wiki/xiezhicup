...
function fn_login_encryption(str) {
    // return XXTEA.encryptToBase64(str, 'dc85de19c77538fb3581605d1f9726b0ac34d9f5');
    return str;
}
// 解密
function fn_decryption(str) {
    return XXTEA.decryptFromBase64(str,'dc85de19c77538fb3581605d1f9726b0ac34d9f5');
}